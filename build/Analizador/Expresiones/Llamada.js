...
class Llamada extends Node_1.Node {
    constructor(identificador, lista_expresiones, fila, columna) {
    ...
    analizar(tabla, arbol) {
        ...
        if (existeFuncion == null) {
            const excepcion = new Excepcion_1.Excepcion('Semantico', `No existe la funcion ${this.nombre_funcion}`, this.fila, this.columna);
